...
"""
Ghost Kitchen AI Platform - Codebase Condenser
Condenses the entire codebase into a single .txt file with tree structure
...
class GitignoreParser:
    """Parse and apply .gitignore patterns for Ghost Kitchen project"""
    
    # Default ignores for Ghost Kitchen AI Platform
    DEFAULT_IGNORES = [
        # Version control
        '.git',
        '.svn',
...
def main():
    parser = argparse.ArgumentParser(
        description='Condense Ghost Kitchen AI codebase into a single text file',
...
Examples:
  ...
  python scripts/condense_codebase.py --line-numbers     # Add line numbers
    ...
    print(f"🍽️  Ghost Kitchen AI Platform - Codebase Exporter")
    print("=" * 60)
    ...
    output_lines.append("GHOST KITCHEN AI PLATFORM - CODEBASE EXPORT")
    ...
    output_lines.append("PROJECT DESCRIPTION")
    output_lines.append("-" * 40)
    output_lines.append("An autonomous AI-driven platform for managing ghost kitchen operations")
    output_lines.append("in Colombia. Uses LangChain agents for market research, menu creation,")
    output_lines.append("demand forecasting, and multi-channel marketing.")
    output_lines.append("")
    output_lines.append("Tech Stack: Python, FastAPI, LangChain, Supabase, OpenAI, Perplexity")
    output_lines.append("")
